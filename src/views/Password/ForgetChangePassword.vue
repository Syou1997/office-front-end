...
export default {
    ...
    methods: {
        ...
        //變更密碼
        changePassword() {
            if (this.userId === null || this.inputNewPwd === null || this.inputNewPwd2 == null) {
            ...
            if (this.inputNewPwd !== this.inputNewPwd2) {
                ...
                //防呆通過執行變更密碼的程式
                axios.post('http://localhost:8080/forget_change_password/', {
        ...
        getLinkParams() {
            //取得網址參數
            this.linkParams = this.$route.query.pwd;
            //根據網址的加密密碼來取得UserId
            //Get
            fetch("http://localhost:8080/pwd_to_userid?pwd=" + this.linkParams)
                .then(res => res.json())
                .then(data => {
            ...
            <div class="login">
                <div class="login-aera">
                    <div class="input-aera1">
                        <span>User ID</span>
                        <input :value="userId" class="input-id" type="number" readonly>
                    </div>
                    ...
                    <div class="button-aera">
                        <button @click="changePassword" type="button">變更密碼</button>
