               ...
               <table>
                    ...
                    <tbody>
                         <tr v-for="item, index in userLeaveList.slice(pageStart, pageEnd)">
                              ...
                              <td>{{ item.leave }}</td>
                              <td> {{ item.leaveReason }}
                                   <button class="fullBtn" @mouseover="showLeaveReasonFull(item)" href="#"
                                        :title="leaveReasonFullText">
                                   </button>
                              </td>
                              <td>{{ item.startDay }}</td>
                              <td>{{ item.endDay }}</td>
                              ...
                              <td>{{ item.ps }}
                                   <button class="fullBtn" @mouseover="showPsFull(item)" href="#" :title="psFullText">
                                   </button>
                              </td>
                              <td>{{ item.auditor }}</td>
                              <td>{{ item.state }}</td>
                              <td>{{ item.failReason }}
                                   <button class="fullBtn" @mouseover="showFailReasonFull(item)" href="#"
                                        :title="failReasonFullText">
                                   </button>
                              </td>
